        ...
        <Combobox<TrackObjectFull> value={selected} onChange={onChange} nullable>
            <div className="relative w-full space-y-3">
                <div className="relative rounded bg-slate-700 w-full h-12">
                    ...
                    />
                    <Combobox.Button aria-label="Expand combobox" className="absolute inset-y-0 right-0 flex items-center px-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 15L12 18.75 15.75 15m-7.5-6L12 5.25 15.75 9" />
                        </svg>
                    </Combobox.Button>
                </div>
                <Combobox.Options className="absolute right-0 bg-slate-700 max-h-60 w-full rounded py-3 overflow-y-auto overflow-x-hidden z-10 drop-shadow-md">
